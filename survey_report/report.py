...
class Texts:
    ...
    BRIGHT_AND_VIBRANT = 'Mauris urna nunc, eleifend id sapien eget, 2. ' \
    ...
    DARK_AND_MUTED = 'Mauris urna nunc, eleifend id sapien eget, 2. Question - ANSWER_1' \
                     ' or ANSWER_3 tincidunt venenatis risus...'
    PASTEL_AND_SOFT = 'In nisl ligula, porttitor vel lobortis vel, commodo quis mi...'
    NO_ATTENTION = 'Mauris urna nunc, eleifend id sapien eget, 2. Question - ANSWER_1 or ' \
    ...
    def shopping_category(self):
        ...
        if q3_answers is not None:
            if set(self.survey.Q3) == {Answers.TOPS, Answers.DRESSES_AND_JUMPSUITS, Answers.ACCESSORIES}:
                self.text += 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed sollicitudin leo in 3.' \
        ...
        if q4_data is not None:
            ...
            if 'size' in q4_data:
                ...
                self.text += f"Your clothing size is" \
                             f" {q4_data['size']} {self.calculate_recommendation(size=clothe_size)}"
    ...
    def preference_on_recycling_material(self):
        ...
        if q5_data and isinstance(q5_data, dict) and 'answer' in q5_data:
            if q5_data['answer'] == Answers.NO:
                self.text += 'Nam maximus et massa laoreet congue. In facilisis egestas neque.' \
                ...
                if Answers.CHOICE_ORGANIC in choices and Answers.CHOICE_RECYCLING in choices:
                ...
                elif Answers.CHOICE_WATER in choices and Answers.CHOICE_NOT_SURE in choices:
